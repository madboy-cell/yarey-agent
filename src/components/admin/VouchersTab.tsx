...
// Types
import { Treatment, TreatmentVariant, Voucher, Client } from "@/types"
...
export function VouchersTab({ vouchers, treatments, clients, onScan }: VouchersTabProps) {
    ...
    const generateVoucher = async () => {
        ...
        setVoucherForm({ treatmentId: "", pricePaid: 0, recipientName: "", validityPeriod: "3M", customExpiration: "", clientId: undefined, isPackage: false, credits: 10 })
